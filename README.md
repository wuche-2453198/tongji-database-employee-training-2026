...
This readme mirrors the readme from tongji-database-employee-training-2026/database/oracle/README.md.
The oracle directory manages the deployment, lifecycle initialization, and seed data for the 13 core business tables.
