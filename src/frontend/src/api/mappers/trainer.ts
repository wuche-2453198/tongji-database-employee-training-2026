...
export const mapTrainerRecord = (dto: TrainerDto): Trainer => ({
  id: String(dto.trainerId), name: dto.trainerName, title: dto.title, company: dto.company,
  phone: dto.phone, email: dto.email, starLevel: Number(dto.starLevel), isInternal: dto.isInternal === 'Y',
})
